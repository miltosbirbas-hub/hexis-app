// ============================================================================
// HEXIS Νομοθεσία — Supabase Edge Function «nomothesia-ai»
// Proxy προς Anthropic API με server-side key (ίδιο pattern με translate-report)
//
// Deploy:
//   supabase functions deploy nomothesia-ai --no-verify-jwt --project-ref oucqqudfdimccgowvpqp
//   supabase secrets set ANTHROPIC_API_KEY=sk-ant-... --project-ref oucqqudfdimccgowvpqp
//
// Τοποθέτηση αρχείου: supabase/functions/nomothesia-ai/index.ts
// ============================================================================

const CORS = {
  "Access-Control-Allow-Origin": "*", // περιόρισέ το σε https://hexis-app.gr αν θες
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // tools: μόνο web_search επιτρέπεται· το fast mode δεν στέλνει tools (ταχύτερο)
