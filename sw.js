...
const PRECACHE = ['intro.mp4', 'checkmydxf.html', 'nomothesia.html', 'nomothesia-manifest.json', 'nomothesia-icon-192.png', 'nomothesia-icon-512.png', 'nomothesia-icon-maskable.png'];
